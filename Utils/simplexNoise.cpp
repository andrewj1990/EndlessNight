...
float SimplexNoise::octaveNoise(const float& octaves, const float& persistence, const float& scale, const float& x, const float& y)
{
	float total = 0;
...
float SimplexNoise::scaledOctaveNoise(const float& octaves, const float& persistence, const float& scale, const float& loBound, const float& hiBound, const float& x, const float& y)
{
	return octaveNoise(octaves, persistence, scale, x, y) * (hiBound - loBound) / 2.0f + (hiBound + loBound) / 2.0f;
}

float SimplexNoise::scaledRawNoise(const float& loBound, const float& hiBound, const float& x, const float& y)
{
	return rawNoise(x, y) * (hiBound - loBound) / 2.0f + (hiBound + loBound) / 2.0f;
}

float SimplexNoise::rawNoise(const float& x, const float& y)
{
